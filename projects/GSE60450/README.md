...
# 1. Download the raw gene-wise count matrix from GEO (data/raw/ is gitignored).
mkdir -p projects/GSE60450/data/raw
curl -L -o projects/GSE60450/data/raw/GSE60450_Lactation-GenewiseCounts.txt.gz \
  https://ftp.ncbi.nlm.nih.gov/geo/series/GSE60nnn/GSE60450/suppl/GSE60450_Lactation-GenewiseCounts.txt.gz

# 2. Render (DESeq2 ~ stage + cell_type).
